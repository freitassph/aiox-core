...
Create the complete packaging design for a product — from physical structure and dieline to graphic design, photorealistic 3D mockups, and print technical specifications — ensuring the package protects the product, communicates the brand, and stands out on the shelf.

## Pre-Conditions

- [ ] Product information and dimensions available
- [ ] Brand guidelines and brand system accessible
- [ ] Regulatory requirements for the product category identified
- [ ] pdg-packaging-designer agent activated
- [ ] Dependency tasks (brand-identity, product-info gathering) completed

# Task: Design Packaging

## Entrada
- `product-info`: Product dimensions, weight, fragility, conservation requirements
- `category`: Product category and market segment
- `shelf-context`: Retail environment and competitor shelf analysis
- `regulatory-requirements`: Mandatory labeling, nutritional info, warnings, symbols

## Saida
- `structural-design`: Packaging structural design with dieline and material specifications
- `graphic-design`: Complete graphic design for all faces (primary, informational, regulatory)
- `3d-mockups`: Photorealistic 3D renders (6+ angles including hero, shelf scene)
- `print-spec`: Print specification document with color system, finishes, and process
- `dieline`: Technical dieline with exact measurements, bleed, folds, and tabs
