...
if (squadYamlRaw && yaml) {
  try {
    ...
    check(!!squadYaml.components, 'squad.yaml has components section');
    check(!!squadYaml.components?.agents, 'squad.yaml lists agents');
    check(!!squadYaml.components?.tasks, 'squad.yaml lists tasks');
    check(!!squadYaml.components?.workflows, 'squad.yaml lists workflows');
    check(!!squadYaml.components?.checklists, 'squad.yaml lists checklists');
    check(!!squadYaml.components?.templates, 'squad.yaml lists templates');
  } catch (e) {
